...
export default function AdicionarLavoura() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // 3. Preparar geometria no formato correto para PostGIS
      ...
      // 4. Criar objeto no formato esperado pelo PostGIS
      const geometriaPostGIS = {
        type: 'Polygon',
      ...
      toast.success(`Lavoura "${data.nome}" cadastrada com sucesso!`)
