        ...
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-lg">{talhaoData.tipo_cultura || 'Não informado'}</p>
            </div>
            ...
            <div>
              ...
              <p className="text-lg">{talhaoData.sistema_irrigacao || 'Não informado'}</p>
            </div>
            ...
            <div>
              ...
              <p className="text-lg">{talhaoData.data_plantio || 'Não informada'}</p>
            </div>
            ...
            <div>
              ...
              <p className="text-lg">{talhaoData.descricao || 'Não informada'}</p>
            </div>
              ...
              fields={[
                {
                  ...
                  type: "talhao",
                  coords: points.filter((p) => p.lat && p.lng).map((p) => [p.lat, p.lng]),
                },
              ]}
